...
int angulo_servo = 0; // ángulo inicial
...
void loop() {
  ...
  if (!escalon_activado && (millis() - tiempo_inicio_loop > 3000)) { // mueve el servo tras 3 segundos
    angulo_servo = 90;
    miServo.write(angulo_servo);
    escalon_activado = true; // Se cierra el candado
  }

  if (millis() - tiempo_impresion > 50) { // tiempo entre la impresion de cada nuevo dato
