...
slider = tk.Scale(ventana, from_=180, to=0, orient='vertical',  # limites del slider, modificar segun eslabon y codigo de arduino
                  length=250, width=30, command=enviar_angulo)

slider.set(90) # posicion de arranque del slider, dependiendo del codigo de arduino puede ser necesario cambiarlo a 0 o 180
slider.pack()
